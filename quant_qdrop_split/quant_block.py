...
from quant_qdrop_split.quant_layer import QuantModule, UniformAffineQuantizer, StraightThrough
...
class QuantSMVMatMul(nn.Module):
    def __init__(
        ...
        # self.act_quantizer_w = ApotQuantizer(sm_abit)
...
class QuantTimestepEmbedSequential(TimestepEmbedSequential):
    ...
    def __init__(self, sub_module: TimestepEmbedSequential):
        super().__init__()
        setattr(self, '0', sub_module[0])
        setattr(self, '1', sub_module[1])
        setattr(self, '2', sub_module[2])
